...
const initialPlayers: Player[] = [
  { id: 1, name: "nixon.eth", health: 20, hand: ["Strike", "Shield", "Steal", "Skip", "All-In"], alive: true },
  { id: 2, name: "dinesh.eth", health: 20, hand: ["Heavy Hit", "Reflect", "Swap", "Strike", "Second Chance"], alive: true },
  { id: 3, name: "thiru.eth", health: 20, hand: ["Strike", "Shield", "Steal", "Skip", "All-In"], alive: true },
  { id: 4, name: "vijay.eth", health: 20, hand: ["Heavy Hit", "Reflect", "Swap", "Strike", "Second Chance"], alive: true },
];
...
export default function MockGame() {
  ...
  const handleStealChoice = (card: string) => {
    ...
    setPlayers(newState);
    addLog(`nixon.eth steals ${card} from ${stealTarget.name}`);
